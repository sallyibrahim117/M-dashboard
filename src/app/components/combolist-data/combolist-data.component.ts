...
@Component({
  ...
  standalone: true,
  imports: [TablesComponent, ChartModule, CommonModule, CalendarModule, FormsModule, ViewComponent, ChangeProgresbarComponent, EaringCardComponent],
...
myearningData:any[]=[{
  headnumber:69.700,smallText:"Projects Earnings in April",arrofdata: [
    { bgcolor: "#198754", des: "Leaf CRM", value: "$7,660" },
    {
      bgcolor:"#0d6efd",des:"Mivy App",value:"$2,820"
    },
...
//   }
 ...
 progressBarData=signal<any>({
  count:69 ,smallText:"Active Projects",text:"43 Pending",value:72,backgroundColor:"#F8285A"
 })
